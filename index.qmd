...
### a small monetary policy system analysis {style="color:#ff68b4;"}
...
### [R script](https://github.com/bsvars/2024-10-be24-bsvars/blob/main/be24-bsvars.R) for Australian monetary policy analysis{style="color:#ff68b4;"}
...
## <span style="color: #ff68b4;">a small monetary policy system analysis</span> {background-color="#001D31"}

## a small monetary policy system analysis
...
post |> 
  forecast(horizon = 8, exogenous_forecast = us_fiscal_ex_forecasts) |> 
